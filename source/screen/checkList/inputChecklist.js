...
const InputChecklist = () => {
    ...
    const pertanyaanChangeHandler = (val, idx, i) => {
        ...
        // newData = dtKategoriPemeriksaan.filter(function(item) {
        //     const itemData = item.IdTipeCeklist.toUpperCase();
        //     const textData = val.toUpperCase();
        //     return itemData.includes(textData);
        // })
        // setKategoriPemeriksaan([...newData]);
    }
    ...
    const addFormPertanyaanHandler = (i) => {
        ...
        setInputList(newData)
        // let x = inputPertanyaan.length
        // let newData = [...inputPertanyaan]

        // newData.push({ id: x + 1 })

        // setInputPertanyaan(newData)
    }
                ...
                <ScrollView ref={scrollRef} style={{ marginHorizontal: 10 }} >
                    ...
                    <View style={{ justifyContent: 'space-between', marginTop: 20, flex: 1 } }>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
                            ...
                            <View style={{ marginHorizontal: 2.5, paddingHorizontal: 20, paddingVertical: 3, borderRadius: 10, backgroundColor: '#FF6347' }}>
